...
Este ajuste se aplica al abrir el Modo Live desde dentro de la app. El [widget «Escucha rápida»](live-mode.md) siempre empieza a escuchar al tocarlo, sea cual sea el valor de este ajuste, y no lo modifica.
