...
This setting governs opening Live mode from inside the app. The [Quick Listen widget](live-mode.md) always starts listening when tapped, whatever this is set to, and leaves the setting untouched.
