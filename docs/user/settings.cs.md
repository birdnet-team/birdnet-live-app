...
Výjimkou je widget **BirdNET Live shortcut** pro Android: otevření Live Mode z tohoto widgetu vždy automaticky spustí nahrávání, jakmile je model připraven, i když je toto nastavení vypnuté. Tato zkratka se tak chová jako vyhrazený rychlý start, ne jen jako pasivní spouštěč aplikace.
