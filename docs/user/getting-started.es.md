...
BirdNET Live ofrece dos widgets de Android: **BirdNET Live shortcut** y **BirdNET Live statistics**.

- Solo Android. La compatibilidad con pantalla de bloqueo depende del dispositivo y del host de widgets.
- Consulte [Widgets de Android](android-widgets.md) para configuración, comportamiento y detalles de uso.
